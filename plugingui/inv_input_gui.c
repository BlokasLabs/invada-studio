...
instantiateIInputGui(const struct _LV2UI_Descriptor* descriptor, const char* plugin_uri, const char* bundle_path, LV2UI_Write_Function write_function, LV2UI_Controller controller, LV2UI_Widget* widget, const LV2_Feature* const* features)
{
	...
	inv_switch_toggle_set_tooltip(INV_SWITCH_TOGGLE (pluginGui->togglePhaseL), "<small><b>Description:</b> This switch inverts the phase of the left channel.\n<b>Usage:</b> Click to toggle between values.</small>");
	...
	inv_switch_toggle_set_tooltip(INV_SWITCH_TOGGLE (pluginGui->togglePhaseR), "<small><b>Description:</b> This switch inverts the phase of the right channel.\n<b>Usage:</b> Click to toggle between values.</small>");
	...
	inv_knob_set_tooltip(INV_KNOB (pluginGui->knobGain), "<small><b>Description:</b> This knob sets the input gain.\n<b>Usage:</b> Click and drag vertically to change value, hortizontally to change the sensitvity.</small>");
	...
	inv_knob_set_tooltip(INV_KNOB (pluginGui->knobPan), "<small><b>Description:</b> This knob controls the balance between the left and right channels.\n<b>Usage:</b> Click and drag vertically to change value, hortizontally to change the sensitvity.</small>");
	...
	inv_knob_set_tooltip(INV_KNOB (pluginGui->knobWidth), "<small><b>Description:</b> This knob controls the relative mix of mono and stereo information within the signal.\n<b>Usage:</b> Click and drag vertically to change value, hortizontally to change the sensitvity.</small>");
